...
@lombok.AllArgsConstructor @lombok.Getter @lombok.Setter class NonEmptyPlain {
  ...
  public @java.beans.ConstructorProperties({"i", "s", "o", "p"}) @java.lang.SuppressWarnings("all") NonEmptyPlain(final @lombok.NonEmpty int i, final @lombok.NonEmpty String s, final @lombok.NonNull @lombok.NonEmpty Object o, final @Nullable @lombok.NonEmpty Object p) {
    super();
