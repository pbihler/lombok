...
class NonEmptyPlain {
	...
	@java.beans.ConstructorProperties({"i", "s", "o", "p"})
	@java.lang.SuppressWarnings("all")
	public NonEmptyPlain(@lombok.NonEmpty final int i, @lombok.NonEmpty final String s, @lombok.NonNull @lombok.NonEmpty final Object o, @Nullable @lombok.NonEmpty final Object p) {
